...
apt-get install -y 	kde-plasma-desktop plasma-workspace 	kio-extras systemsettings xinit xserver-xorg-core xserver-xorg-video-all 	plasma-nm kdenetwork 	konsole dolphin kate kde-spectacle --install-recommends
...
apt-get install -y 	polkit-kde-agent-1 policykit-desktop-privileges --no-install-recommends
...
apt-get install -y 	calamares calamares-settings-kubuntu kubuntu-settings-desktop --no-install-recommends
...
apt-get install -y 	update-notifier-common ubuntu-release-upgrader-core apport --no-install-recommends
...
apt-get install -y 	sddm --no-install-recommends
...
apt-get install -y 	network-manager-applet nm-connection-editor 	network-manager-openconnect-gnome network-manager-openvpn-gnome network-manager-pptp-gnome 	bluetooth blueman bluez --install-recommends
